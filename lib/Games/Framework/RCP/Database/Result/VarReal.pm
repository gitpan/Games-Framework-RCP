package Games::Framework::RCP::Database::Result::VarReal;
...
sub sqlt_deploy_hook {
    ...
    $sqlt_table->comments('List of real (double/float) variables.');
}
...
Games::Framework::RCP::Database::Result::VarReal - List of real (double/float) variables.
...
The vars real table contains a list of real number variables, or
...
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Games-Framework-RCP-Database-Result-VarReal>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Games-Framework-RCP-Database-Result-VarReal>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Games-Framework-RCP-Database-Result-VarReal>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Games-Framework-RCP-Database-Result-VarReal>

=item * Search CPAN

L<http://search.cpan.org/dist/Games-Framework-RCP-Database-Result-VarReal/>
